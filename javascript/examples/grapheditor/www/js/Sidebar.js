...
Sidebar.prototype.init = function()
{
	...
	this.addImagePalette('totalPlay', mxResources.get('totalPlay'), dir + '/clipart/', '_128x128.png',
		['Database', 'Router_Icon', 
		 'Server_Tower',  'Wireless_Router_N',  'Suit1', 'Suit2']
		 , null,
...
Sidebar.prototype.addMiscPalette = function(expand)
{
	...
	var fns = [
   	 	this.createVertexTemplateEntry('text;strokeColor=none;fillColor=none;html=1;fontSize=24;fontStyle=1;verticalAlign=middle;align=center;', 100, 40, 'Anillo', 'Titulo', null, null, 'text heading title'),
